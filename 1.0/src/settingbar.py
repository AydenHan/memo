...
#          Desc: 最小化设置
# =============================================================================
from PyQt5.QtWidgets import qApp,QLabel,QVBoxLayout,QHBoxLayout,QTextEdit,QFontDialog,QDialog,QApplication,QColorDialog
...
class SettingBar(QDialog):
    ...
    def center(self):
        ...
        x = (desktop.width() - self.width()) / 2 - self.width()
        y = (desktop.height() - self.height()) / 2 - self.height()
