...
class SideBar(QWidget):
    ...
    def initModule(self):
        ...
        self.layout.addWidget(self.dataBtn, 1, Qt.AlignCenter)
    ...
    def setModule(self):
        ...
        self.dataBtn.setMinimumSize(30, 30)
        self.dataBtn.setMaximumSize(30, 30)
        ...
        self.dataBtn.setStyleSheet(css.sidebar_data)
